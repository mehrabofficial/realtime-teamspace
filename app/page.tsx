  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white px-6 py-16">
      <section className="mx-auto max-w-5xl">
        ...
        <h1 className="mt-4 text-4xl font-bold tracking-tight md:text-6xl">Realtime Teamspace</h1>
        <p className="mt-6 max-w-2xl text-lg text-slate-300">Real-time project management and team collaboration app with Kanban workflow.</p>
